...
$('telegramSaveSettingsBtn')?.addEventListener('click',saveTelegramSettings);$('telegramTestBtn')?.addEventListener('click',()=>invokeTelegram('test'));$('telegramSummaryBtn')?.addEventListener('click',()=>invokeTelegram('manual_summary'));$('telegramResetFlagsBtn')?.addEventListener('click',resetDeadlineFlags);$('exportEventSelect')?.addEventListener('change',()=>setTimeout(loadTelegramSettings,50));document.addEventListener('juvenilia:event-changed',()=>setTimeout(loadTelegramSettings,80));document.querySelector('[data-tab="exports"]')?.addEventListener('click',()=>setTimeout(loadTelegramSettings,50));setTimeout(loadTelegramSettings,1000);
